"""Tests for pysysfan.service — Windows Task Scheduler integration."""

from unittest.mock import patch, MagicMock

import pytest

from pysysfan.service import (
    _pysysfan_exe,
    install_task,
    uninstall_task,
    get_task_status,
...
class TestPysysfanExe:
    ...
    @patch("pysysfan.service.shutil.which")
    ...
    @patch("pysysfan.service.shutil.which", return_value=None)
...
class TestInstallTask:
    ...
    @patch("pysysfan.service.subprocess.run")
    @patch("pysysfan.service._pysysfan_exe", return_value=r"C:\tools\pysysfan.exe")
